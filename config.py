...
def get_arguments():
    ...
    parser = argparse.ArgumentParser(description="Clothing Retrieval from Class Aware Attention to Deep Embedding Distance Learning")

    # INPUT & OUTPUT
    parser.add_argument('--filepath', default='G:/Clothing_Dataset', type=str)
